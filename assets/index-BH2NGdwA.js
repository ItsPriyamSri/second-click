(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function t(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(o){if(o.ep)return;o.ep=!0;const a=t(o);fetch(o.href,a)}})();const f="dl-real",p="dl-swap",T=[{id:"dl-decoy-1",label:"DOWNLOAD NOW",shownUrl:"/ads/offer-1",secondUrl:null,hops:[],kind:"decoy",trapType:"decoy"},{id:"dl-decoy-2",label:"GET THE APP",shownUrl:"/ads/offer-2",secondUrl:null,hops:[],kind:"decoy",trapType:"decoy"},{id:f,label:"Download DemoApp",shownUrl:"/continue/real",secondUrl:null,hops:[],kind:"real",trapType:"none"},{id:"dl-decoy-3",label:"DOWNLOAD (FAST)",shownUrl:"/ads/offer-3",secondUrl:null,hops:[],kind:"decoy",trapType:"decoy"},{id:"dl-decoy-4",label:"MIRROR #1",shownUrl:"/ads/offer-4",secondUrl:null,hops:[],kind:"decoy",trapType:"decoy"},{id:"dl-decoy-5",label:"INSTALLER",shownUrl:"/ads/offer-5",secondUrl:null,hops:[],kind:"decoy",trapType:"decoy"},{id:"dl-decoy-6",label:"CLICK HERE",shownUrl:"/ads/offer-6",secondUrl:null,hops:[],kind:"decoy",trapType:"decoy"},{id:"dl-decoy-7",label:"FREE APK",shownUrl:"/ads/offer-7",secondUrl:null,hops:[],kind:"decoy",trapType:"decoy"}],_=[{id:p,label:"DemoApp.apk",shownUrl:"/ads/click-here",secondUrl:"/you-clicked-once.txt",hops:["/ads/hop-1","/ads/hop-2","/you-clicked-once.txt"],kind:"two_url",trapType:"second_click"}];function d(e){return e==="field"?T:e==="hops"?_:[]}function C(){return{room:"door",walls:{cookie:!0,notify:!0,signup:!0},personGateDone:!1,highlightedId:null,dimmedIds:[],revealedIds:[],chainVisibleFor:null,explain:null,confirmArmed:!1,confirmOpen:!1}}function A(e){const n=[];e.walls.cookie&&n.push("cookie"),e.walls.notify&&n.push("notify"),e.walls.signup&&n.push("signup"),e.personGateDone||n.push("person_gate");const t=e.room==="field"||e.room==="hops";return{visible:n.length===0&&t,blocking:n}}function b(e,n){return d(e.room).find(t=>t.id===n)}function E(e){return{...e,walls:{cookie:!1,notify:!1,signup:!1}}}function U(e,n){return{...e,walls:{...e.walls,[n]:!1}}}function L(e){return{...e,personGateDone:!0}}function P(e){return e.walls.cookie||e.walls.notify||e.walls.signup||!e.personGateDone?e:{...e,room:"field"}}function R(e){return e.room!=="field"?e:{...e,room:"hops",highlightedId:null,dimmedIds:[],revealedIds:[],chainVisibleFor:null,explain:null,confirmArmed:!1,confirmOpen:!1}}function N(e){return e.room==="field"?{...e,highlightedId:f}:e.room==="hops"?{...e,highlightedId:p}:e}function q(e){if(e.room!=="field")return{...e,dimmedIds:[]};const n=d("field").filter(t=>t.id!==f).map(t=>t.id);return{...e,dimmedIds:n}}function F(e,n){return!b(e,n)||e.revealedIds.includes(n)?e:{...e,revealedIds:[...e.revealedIds,n]}}function W(e,n){const t=b(e,n);return!t||t.hops.length===0?e:{...e,chainVisibleFor:n}}const G={decoy:"This button is an ad, not the file.",second_click:"Shown URL is not the second-click URL.",redirect_chain:"This path hops before the file.",none:"This is the real path. The agent still cannot start the file."};function $(e,n){const t=b(e,n);return t?{...e,explain:{id:n,text:G[t.trapType]}}:e}function M(e){return e.room!=="hops"||!A(e).visible?e:{...e,confirmArmed:!0}}function V(e){return e.confirmArmed?{...e,confirmOpen:!0}:e}function w(e){return{...e,confirmOpen:!1,confirmArmed:!1}}let x=C();const v=new Set;function s(){return x}function r(e){x=e;for(const n of v)n()}function H(e){return v.add(e),()=>{v.delete(e)}}function g(e){return typeof e.id=="string"&&e.id.length>0?e.id:null}function j(){const e=s();return{room:e.room,walls:e.walls,personGateDone:e.personGateDone,highlightedId:e.highlightedId,dimmedIds:e.dimmedIds,revealedIds:e.revealedIds,chainVisibleFor:e.chainVisibleFor,explain:e.explain,confirmArmed:e.confirmArmed,confirmOpen:e.confirmOpen}}function z(){r(E(s()));const e=s();return{closed:["cookie","notify","signup"],personGateDone:e.personGateDone}}function K(){const e=s();return{room:e.room,clickables:d(e.room)}}function B(e){const n=g(e);if(!n)return{error:"id_required"};const t=s(),i=d(t.room).find(o=>o.id===n);return i?(r(F(t,n)),{id:n,shownUrl:i.shownUrl,secondUrl:i.secondUrl,revealed:!0}):{error:"unknown_id"}}function Y(e){const n=g(e);if(!n)return{error:"id_required"};const t=s(),i=d(t.room).find(o=>o.id===n);return i?i.hops.length===0?{error:"no_hops"}:(r(W(t,n)),{id:n,hops:i.hops,shown:!0}):{error:"unknown_id"}}function J(){return r(N(s())),{highlightedId:s().highlightedId}}function X(){return r(q(s())),{dimmedIds:s().dimmedIds}}function Q(e){const n=g(e);if(!n)return{error:"id_required"};const t=s();return d(t.room).find(o=>o.id===n)?(r($(t,n)),s().explain):{error:"unknown_id"}}function Z(){return r(M(s())),s().confirmArmed?{confirmArmed:!0,confirmOpen:!1,message:"Human must confirm. The agent cannot start the file."}:{error:"not_ready",confirmArmed:!1}}function ee(){return A(s())}let I={count:-1,text:"Site tools: waiting for document.modelContext…"};function ne(){return I}function k(e){I=e}function te(e){if(e==null)return{};if(typeof e=="string"){try{const n=JSON.parse(e);if(n&&typeof n=="object"&&!Array.isArray(n))return n}catch{return{}}return{}}return typeof e=="object"&&!Array.isArray(e)?e:{}}function oe(e){if(!e||typeof e!="object")return null;const n=e.modelContext;return n&&typeof n.registerTool=="function"?n:null}function y(){const e=[],n=new Set,t=[];typeof document<"u"&&t.push(document),typeof navigator<"u"&&t.push(navigator),typeof window<"u"&&t.push(window);for(const i of t){const o=oe(i);o&&!n.has(o)&&(n.add(o),e.push(o))}return e}function se(e){return new Promise(n=>setTimeout(n,e))}async function ie(e){const n=Date.now();let t=y();for(;t.length===0&&Date.now()-n<e;)await se(50),t=y();return t}const c={type:"object",properties:{},additionalProperties:!1},m={type:"object",properties:{id:{type:"string",description:"Clickable id"}},required:["id"],additionalProperties:!1},D=[{name:"get_page_state",description:"Read room, walls, paint, and confirm flags.",inputSchema:c,readOnly:!0,run:()=>j()},{name:"dismiss_walls",description:"Close cookie, notify, and signup sheets. Does not complete the person gate.",inputSchema:c,run:()=>z()},{name:"list_clickables",description:"List download-like controls in the current room with shown and second URLs.",inputSchema:c,readOnly:!0,run:()=>K()},{name:"reveal_second_url",description:"Write shown vs second-click URL on the page for one control.",inputSchema:m,run:e=>B(e)},{name:"explain_trap",description:"Write a one-line agent caption on one control.",inputSchema:m,run:e=>Q(e)},{name:"show_redirect_chain",description:"Write the declared hop list for one control. Does not fetch.",inputSchema:m,run:e=>Y(e)},{name:"highlight_real",description:"Paint the real download path in this room.",inputSchema:c,run:()=>J()},{name:"dim_decoys",description:"Dim decoy buttons in the field room.",inputSchema:c,run:()=>X()},{name:"request_open",description:"Ask the human to confirm the dummy file. Does not download.",inputSchema:c,run:()=>Z()},{name:"get_core_visible",description:"Whether junk walls are gone and the core download UI is showing.",inputSchema:c,readOnly:!0,run:()=>ee()}];D.map(e=>e.name);function ae(e){return{...e,content:[{type:"text",text:JSON.stringify(e)}]}}async function S(e){const t=await ie(e??(typeof document>"u"?0:2e4));if(t.length===0)return{registered:[]};const i=[];for(const o of D){const a={name:o.name,description:o.description,inputSchema:o.inputSchema,...o.readOnly?{annotations:{readOnlyHint:!0}}:{},execute:async h=>ae(o.run(te(h)))};let l=!1;for(const h of t)try{await h.registerTool(a),l=!0}catch{}l&&i.push(o.name)}return{registered:i}}function re(e){r(U(s(),e))}function le(e){const n=s(),t=[];if(t.push('<div class="site-wrapper">'),t.push(`
  ...
  `),n.room==="door"&&(t.push(`
    ...
    `);for(const o of d("field")){const a=[o.id===n.highlightedId?"is-real":"",n.dimmedIds.includes(o.id)?"is-dim":""].filter(Boolean).join(" ");t.push(`<button type="button" class="${a}" data-click="${o.id}">${o.label}</button>`),n.explain?.id===o.id&&t.push(`<p class="agent" data-speaker="agent">${n.explain.text}</p>`)}t.push(`
            </div>
          </div>
      ...
      <div class="main-layout">
        <div class="hops-container">
          ...
          <div style="margin-bottom:20px">
            <button type="button" class="${a}" data-click="${o.id}">${o.label}</button>
    `),n.revealedIds.includes(p)&&t.push(`<p class="urls agent" data-speaker="agent">Shown: ${o.shownUrl}
Second click: ${o.secondUrl}</p>`),n.chainVisibleFor===p&&t.push(`<ol class="agent" data-speaker="agent">${o.hops.map(l=>`<li>${l}</li>`).join("")}</ol>`),n.explain?.id===o.id&&t.push(`<p class="agent" data-speaker="agent">${n.explain.text}</p>`),t.push("</div>"),n.confirmArmed&&t.push(`
        <div class="bar">
    ...
    `)}t.push("</div>"),n.walls.cookie&&t.push(`
