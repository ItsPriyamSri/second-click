(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(s){if(s.ep)return;s.ep=!0;const o=t(s);fetch(s.href,o)}})();const f="dl-real",u="dl-swap",_=[{id:"dl-decoy-1",label:"DOWNLOAD NOW",shownUrl:"/ads/offer-1",secondUrl:null,hops:[],kind:"decoy",trapType:"decoy"},{id:"dl-decoy-2",label:"GET THE APP",shownUrl:"/ads/offer-2",secondUrl:null,hops:[],kind:"decoy",trapType:"decoy"},{id:f,label:"Download DemoApp",shownUrl:"/continue/real",secondUrl:null,hops:[],kind:"real",trapType:"none"},{id:"dl-decoy-3",label:"DOWNLOAD (FAST)",shownUrl:"/ads/offer-3",secondUrl:null,hops:[],kind:"decoy",trapType:"decoy"},{id:"dl-decoy-4",label:"MIRROR #1",shownUrl:"/ads/offer-4",secondUrl:null,hops:[],kind:"decoy",trapType:"decoy"},{id:"dl-decoy-5",label:"INSTALLER",shownUrl:"/ads/offer-5",secondUrl:null,hops:[],kind:"decoy",trapType:"decoy"},{id:"dl-decoy-6",label:"CLICK HERE",shownUrl:"/ads/offer-6",secondUrl:null,hops:[],kind:"decoy",trapType:"decoy"},{id:"dl-decoy-7",label:"FREE APK",shownUrl:"/ads/offer-7",secondUrl:null,hops:[],kind:"decoy",trapType:"decoy"}],U=[{id:u,label:"DemoApp.apk",shownUrl:"/ads/click-here",secondUrl:"/you-clicked-once.html",hops:["/ads/click-here","/you-clicked-once.html"],kind:"two_url",trapType:"second_click"}];function c(e){return e==="field"?_:e==="hops"?U:[]}function N(){return{room:"door",walls:{cookie:!0,notify:!0,signup:!0},personGateDone:!1,highlightedId:null,dimmedIds:[],revealedIds:[],chainVisibleFor:null,explain:null,confirmArmed:!1,confirmOpen:!1}}function T(e){const n=[];e.walls.cookie&&n.push("cookie"),e.walls.notify&&n.push("notify"),e.walls.signup&&n.push("signup"),e.personGateDone||n.push("person_gate");const t=e.room==="field"||e.room==="hops";return{visible:n.length===0&&t,blocking:n}}function y(e,n){return c(e.room).find(t=>t.id===n)}function M(e){return{...e,walls:{cookie:!1,notify:!1,signup:!1}}}function F(e,n){return{...e,walls:{...e.walls,[n]:!1}}}function H(e){return{...e,personGateDone:!0}}function q(e){return e.walls.cookie||e.walls.notify||e.walls.signup||!e.personGateDone?e:{...e,room:"field"}}function W(e){return e.room!=="field"?e:{...e,room:"hops",highlightedId:null,dimmedIds:[],revealedIds:[],chainVisibleFor:null,explain:null,confirmArmed:!1,confirmOpen:!1}}function $(e){return e.room==="field"?{...e,highlightedId:f}:e.room==="hops"?{...e,highlightedId:u}:e}function G(e){if(e.room!=="field")return{...e,dimmedIds:[]};const n=c("field").filter(t=>t.id!==f).map(t=>t.id);return{...e,dimmedIds:n}}function V(e,n){return!y(e,n)||e.revealedIds.includes(n)?e:{...e,revealedIds:[...e.revealedIds,n]}}function j(e,n){const t=y(e,n);return!t||t.hops.length===0?e:{...e,chainVisibleFor:n}}const B={decoy:"This button is an ad, not the file.",second_click:"Shown URL is not the second-click URL.",redirect_chain:"This path hops before the file.",none:"This is the real path. The agent still cannot start the file."};function K(e,n){const t=y(e,n);return t?{...e,explain:{id:n,text:B[t.trapType]}}:e}function x(e){return e.room!=="hops"||!T(e).visible?e:{...e,confirmArmed:!0}}function k(e){return e.confirmArmed?{...e,confirmOpen:!0}:e}function S(e){return{...e,confirmOpen:!1,confirmArmed:!1}}let C=N();const b=new Set;function a(){return C}function l(e){C=e;for(const n of b)n()}function z(e){return b.add(e),()=>{b.delete(e)}}function w(e){return typeof e.id=="string"&&e.id.length>0?e.id:null}function Y(){const e=a();return{room:e.room,walls:e.walls,personGateDone:e.personGateDone,highlightedId:e.highlightedId,dimmedIds:e.dimmedIds,revealedIds:e.revealedIds,chainVisibleFor:e.chainVisibleFor,explain:e.explain,confirmArmed:e.confirmArmed,confirmOpen:e.confirmOpen}}function J(){l(M(a()));const e=a();return{closed:["cookie","notify","signup"],personGateDone:e.personGateDone}}function X(){const e=a();return{room:e.room,clickables:c(e.room)}}function Q(e){const n=w(e);if(!n)return{error:"id_required"};const t=a(),i=c(t.room).find(s=>s.id===n);return i?(l(V(t,n)),{id:n,shownUrl:i.shownUrl,secondUrl:i.secondUrl,revealed:!0}):{error:"unknown_id"}}function Z(e){const n=w(e);if(!n)return{error:"id_required"};const t=a(),i=c(t.room).find(s=>s.id===n);return i?i.hops.length===0?{error:"no_hops"}:(l(j(t,n)),{id:n,hops:i.hops,shown:!0}):{error:"unknown_id"}}function ee(){return l($(a())),{highlightedId:a().highlightedId}}function ne(){return l(G(a())),{dimmedIds:a().dimmedIds}}function se(e){const n=w(e);if(!n)return{error:"id_required"};const t=a();return c(t.room).find(s=>s.id===n)?(l(K(t,n)),a().explain):{error:"unknown_id"}}function te(){return l(x(a())),a().confirmArmed?{confirmArmed:!0,confirmOpen:!1,message:"Human must confirm. The agent cannot start the file."}:{error:"not_ready",confirmArmed:!1}}function ae(){return T(a())}let E={count:-1,text:"Site tools: waiting for document.modelContext…"};function ie(){return E}function A(e){E=e}function oe(e){if(e==null)return{};if(typeof e=="string"){try{const n=JSON.parse(e);if(n&&typeof n=="object"&&!Array.isArray(n))return n}catch{return{}}return{}}return typeof e=="object"&&!Array.isArray(e)?e:{}}function re(e){if(!e||typeof e!="object")return null;const n=e.modelContext;return n&&typeof n.registerTool=="function"?n:null}function g(){const e=[],n=new Set,t=[];typeof document<"u"&&t.push(document),typeof navigator<"u"&&t.push(navigator),typeof window<"u"&&t.push(window);for(const i of t){const s=re(i);s&&!n.has(s)&&(n.add(s),e.push(s))}return e}function le(e){return new Promise(n=>setTimeout(n,e))}async function de(e){const n=Date.now();let t=g();for(;t.length===0&&Date.now()-n<e;)await le(50),t=g();return t}const p={type:"object",properties:{},additionalProperties:!1},v={type:"object",properties:{id:{type:"string",description:"Clickable id"}},required:["id"],additionalProperties:!1},O=[{name:"get_page_state",description:"Read room, walls, paint, and confirm flags.",inputSchema:p,readOnly:!0,run:()=>Y()},{name:"dismiss_walls",description:"Close cookie, notify, and signup sheets. Does not complete the person gate.",inputSchema:p,run:()=>J()},{name:"list_clickables",description:"List download-like controls in the current room with shown and second URLs.",inputSchema:p,readOnly:!0,run:()=>X()},{name:"reveal_second_url",description:"Write shown vs second-click URL on the page for one control.",inputSchema:v,run:e=>Q(e)},{name:"explain_trap",description:"Write a one-line agent caption on one control.",inputSchema:v,run:e=>se(e)},{name:"show_redirect_chain",description:"Write the declared hop list for one control. Does not fetch.",inputSchema:v,run:e=>Z(e)},{name:"highlight_real",description:"Paint the real download path in this room.",inputSchema:p,run:()=>ee()},{name:"dim_decoys",description:"Dim decoy buttons in the field room.",inputSchema:p,run:()=>ne()},{name:"request_open",description:"Ask the human to confirm the dummy file. Does not download.",inputSchema:p,run:()=>te()},{name:"get_core_visible",description:"Whether junk walls are gone and the core download UI is showing.",inputSchema:p,readOnly:!0,run:()=>ae()}];O.map(e=>e.name);function ce(e){return{...e,content:[{type:"text",text:JSON.stringify(e)}]}}async function D(e){const t=await de(e??(typeof document>"u"?0:2e4));if(t.length===0)return{registered:[]};const i=[];for(const s of O){const o={name:s.name,description:s.description,inputSchema:s.inputSchema,...s.readOnly?{annotations:{readOnlyHint:!0}}:{},execute:async d=>ce(s.run(oe(d)))};let r=!1;for(const d of t)try{await d.registerTool(o),r=!0}catch{}r&&i.push(s.name)}return{registered:i}}let h=!1,I=0;function pe(e){l(F(a(),e))}function R(e){const n=a(),t=[];if(t.push('<div class="site-wrapper">'),t.push(`
  ...
  `),n.room==="door"&&(t.push(`
    ...
    `);for(const s of c("field")){const o=[s.id===n.highlightedId?"is-real":"",n.dimmedIds.includes(s.id)?"is-dim":""].filter(Boolean).join(" ");let r=s.label;if(s.id===f?r='<div class="real-btn-inner"><span class="real-btn-title">Download DemoApp.apk (42.1 MB)</span><span class="real-btn-sub">HTTP Direct Mirror • Standard Speed (Free)</span></div>':s.id==="dl-decoy-1"?r=`<span class="anim-down-arrow">⬇</span> ${s.label}`:s.id==="dl-decoy-3"?r=`⚡ ${s.label}`:s.id==="dl-decoy-4"?r=`↓ ${s.label}`:s.id==="dl-decoy-6"?r=`⚠️ ${s.label}`:s.id==="dl-decoy-7"&&(r=`📱 ${s.label}`),t.push('<div class="field-btn-wrapper">'),n.explain?.id===s.id){const d=s.kind==="real"?"tool-tooltip real-tooltip":"tool-tooltip decoy-tooltip",P=s.kind==="real"?"✓ REAL LINK":"⚠️ AD DECOY";t.push(`<span class="${d}">${P}</span>`)}t.push(`<button type="button" class="${o}" data-click="${s.id}">${r}</button>`),n.explain?.id===s.id&&t.push(`
    ...
    `)}if(n.room==="hops"){const s=c("hops")[0],o=s.id===n.highlightedId?"file file-swap-btn is-real":"file file-swap-btn";t.push(`
      <div class="main-layout">
      ...
      `),n.chainVisibleFor===u&&t.push(`
        <div class="agent-chain-card">
          ...
          <ol class="agent chain-list" data-speaker="agent">
            ${s.hops.map((r,d)=>`
              <li class="hop-item">
                <span class="hop-badge">${d+1}</span>
                <code class="hop-code">${r}</code>
                ${d===s.hops.length-1?'<span class="hop-target-tag">★ DIRECT FILE TARGET</span>':'<span class="hop-ad-tag">AD REDIRECT</span>'}
              </li>
            `).join("")}
          </ol>
        </div>
  ...
  `),n.walls.signup?t.push(`
    ...
    `);const i=ie();t.push(`<p class="mcp-status" data-webmcp-tools="${String(i.count)}">${i.text}</p>`),e.innerHTML=t.join(""),e.querySelectorAll("[data-wall-close]").forEach(s=>{s.addEventListener("click",()=>{pe(s.dataset.wallClose)})}),e.querySelector("[data-act=person]")?.addEventListener("click",()=>{h||a().personGateDone||(h=!0,R(e),setTimeout(()=>{h=!1,l(H(a()))},1600))}),e.querySelector("[data-act=enter-field]")?.addEventListener("click",()=>{l(q(a()))}),e.querySelector("[data-act=open-confirm]")?.addEventListener("click",()=>{l(k(a()))}),e.querySelector("[data-act=cancel-confirm]")?.addEventListener("click",()=>{l(S(a()))}),e.querySelector("[data-act=do-download]")?.addEventListener("click",()=>{l(S(a())),window.location.href="you-clicked-once.html"}),e.querySelectorAll("[data-click]").forEach(s=>{s.addEventListener("click",()=>{const o=s.dataset.click,r=a().room;r==="field"?o===f?l(W(a())):window.location.href="this-was-the-ad.html":r==="hops"&&o===u&&(s.classList.add("active-press"),setTimeout(()=>s.classList.remove("active-press"),180),!a().confirmArmed&&I===0?(I=1,window.location.href="this-was-the-ad.html"):(l(x(a())),l(k(a()))))})})}const L=document.querySelector("#app");if(!(L instanceof HTMLElement))throw new Error("#app missing");const m=()=>R(L);z(m);m();(async()=>{let e=await D(2e4);e.registered.length===0&&(A({count:0,text:g().length?"Site tools: modelContext present but registerTool failed":"Site tools: no document.modelContext. Use ChatGPT desktop in-app browser, GPT-5.6 Sol or Terra, Settings → Browser → Enable site tools. Codex CLI and plain Chrome will not see tools."}),m(),e=await D(6e4)),e.registered.length>0&&(A({count:e.registered.length,text:`Site tools: ${e.registered.length} registered`}),m())})();
